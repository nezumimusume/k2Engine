...
namespace ExitGames
{
	namespace Voice
	{
		...
		public:
			...
			Common::Object buildVoicesInfo(const Common::JVector<const LocalVoice*>& voicesToSend, bool logInfo) const;
			Common::Object buildVoiceRemoveMessage(const LocalVoice& v) const;
			Common::Object buildFrameMessage(nByte voiceId, nByte evNumber, Buffer<nByte> data);
